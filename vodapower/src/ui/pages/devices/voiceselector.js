...
import { Voicedeal } from '../../../components/constants';

export class VoiceDeals extends Component{
  ...
  renderVas = ({item }) => {
      return(
          ...
          navigation={() => this.props.navigation.navigate('Accessory')}
          />
      )
  }
